// Iconos inline compartidos (sin dependencia nueva), mismo estilo trazo que los de
// LoginPage.tsx -- usados en la navegacion de AppLayout y en botones de accion compactos.
interface IconProps {
  size?: number
}

export function ConsoleIcon({ size = 16 }: IconProps) {
  return (
