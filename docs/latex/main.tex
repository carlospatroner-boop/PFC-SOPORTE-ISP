...
\usepackage{enumitem}
\usepackage{float}
% Se agregan nuevos paquetes arreglar los desbordes
...
% (fundamento_teorico_e4 no se incluye: su contenido ya llego a secciones/fundamento_teorico.tex
% via un commit de Cristhian, agregado ahi mismo en vez de en un archivo separado -- se dejo asi
% para no duplicar la seccion en el PDF compilado)
...
\input{secciones/resultado_correl_e4}
