...
\texttt{eslint} con las reglas por defecto de \texttt{\seqsplit{@typescript-eslint}} corre en modo estricto
(\texttt{--max-warnings 0}: cualquier advertencia rompe la compilación, no solo los errores). La
cobertura de pruebas (Vitest + Testing Library) alcanza el 87.6\,\% de líneas sobre el total de la
aplicación, con la única brecha significativa en el componente de detalle recién agregado
(\texttt{TicketDetailModal.tsx}, 34.8\,\%), pendiente de cubrir antes del cierre del proyecto.
