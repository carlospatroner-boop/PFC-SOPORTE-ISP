\section{Conclusiones de la Entrega 3 (integración con E4)}
...
\begin{itemize}[leftmargin=1.5em]
    \item \textbf{El esquema de base de datos fragmentado} (migración Flyway versionada
        \texttt{V1\_\_init\_ticket\_schema.sql} desde el Entregable 5 de la guía de cierre,
        antes un guion suelto sin versionar; ADR-0003) y el propio \textbf{clúster de tres
        nodos de CockroachDB} quedan como la capa de
