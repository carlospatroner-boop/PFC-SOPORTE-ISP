...
El único resultado numérico que depende de una ejecución prolongada y de coordinación logística del
equipo que sigue sin ejecutarse es la caracterización de tolerancia a fallos ante la caída de uno y
dos nodos: se documenta en este trabajo con su diseño e implementación completos, pero su valor
numérico final se reporta como pendiente de la ejecución programada para el cierre de esta entrega,
en línea con el compromiso de no sustituir mediciones reales por estimaciones a lo largo de todo el
documento.
