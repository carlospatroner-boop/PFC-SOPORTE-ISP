...
\midrule
gRPC &
  \texttt{\seqsplit{services/telemetry-service/src/main/proto/telemetry.proto}} y
...
CQRS &
  Separación por servicio: \texttt{\seqsplit{svc-principal/application/command/}} concentra la escritura
