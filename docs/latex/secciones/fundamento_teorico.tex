...
\label{sec:fundamento-modelo-paralelo}
...
protocolo de calidad de producto; su fundamento teórico, para no mezclarlo con el de las entregas
anteriores en esta misma sección, se desarrolla en la Sección~\ref{sec:fundamento-teorico-e4}, ya
dentro de la Parte~\ref{part:aportes-e4}.
