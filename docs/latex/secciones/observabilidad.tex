...
(\texttt{\seqsplit{LogstashEncoder}}), incluyendo el campo \texttt{trace\_id}. El agente Java de
...
\texttt{\seqsplit{ops/grafana/pfc-dashboard.json}}, incluye los seis paneles obligatorios: tasa de
