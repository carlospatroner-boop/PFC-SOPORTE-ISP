...
Integración & Testcontainers & ¿Funciona contra un CockroachDB real, no un \emph{mock}? & \texttt{\seqsplit{TicketRepositoryIntegrationTest}} \\
Contrato & Pact (consumidor + proveedor) & ¿El backend sigue la forma exacta que el cliente espera? & 2/2 consumidor, 2/2 proveedor \\
E2E & Playwright / Compose Testing & ¿Todo el camino, navegador real incluido, funciona? & 9/9 en \seqsplit{Chromium+Firefox+WebKit} \\
...
6 & \texttt{\seqsplit{build-mobile-apk}} & Compila el APK de depuración y lo publica como artefacto \\
...
proyecto Java real. El reporte HTML de JaCoCo que respalda esta cifra —no solo una tabla escrita
a mano— está publicado en \texttt{docs/evidencias/jacoco-svc-principal/}, junto con el archivo
binario crudo (\texttt{jacoco.exec}) para quien quiera regenerarlo o verificarlo con otra
herramienta.
