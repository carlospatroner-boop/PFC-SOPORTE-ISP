...
\midrule
Unitaria & JUnit 5 / Vitest / JUnit Android & ¿Esta clase, aislada, hace lo que dice? & 126/126 backend (3 servicios Java + Node + Python), 75/75 web, 5/5 móvil \\
...
2 & \texttt{test-backend} & Los tres servicios Java con pruebas automatizadas + Node + Python, pruebas unitarias e integración \\
