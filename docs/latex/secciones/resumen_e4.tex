...
en un pipeline de CI/CD de siete \emph{jobs}; y se midieron cinco características de calidad con
métricas objetivas e intervalos de confianza al 95\,\%. \textbf{Resultados.} El sistema cumple
Compatibilidad (9/9 pruebas E2E en tres navegadores) y Mantenibilidad (81.1\,\% de cobertura de
...
three-browser E2E, Locust load) was automated in a seven-job CI/CD pipeline; and five quality
...
Maintainability (81.1\,\% test coverage and a cyclomatic complexity of 1.8, both within
