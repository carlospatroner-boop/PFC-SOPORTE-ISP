 ...
 * patron, no la URI literal, para no explotar la cardinalidad), metodo y codigo.
 * Misma implementacion que ticket-service/report-service (no hay un modulo compartido
 * entre microservicios en este PFC, ver ADR-002).
 */
@Component
