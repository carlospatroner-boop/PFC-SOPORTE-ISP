 ...
 * a los enums Category/Priority en infrastructure/messaging/TicketClassificationListener
 * (con manejo de valores desconocidos, por si ai-service y ticket-service llegan a
 * desincronizar su vocabulario de categorias).
 */
